...
using azuretest_2.WebApi.Seedwork.CustomProblemDetails;
...
namespace azuretest_2.WebApi.CustomMiddleware
{
    public class ErrorHandling
    {
        ...
        public ErrorHandling(RequestDelegate next, IWebHostEnvironment env)
        {
            _next = next;
            _env = env;
        }
        ...
        private ProblemDetails GetProblemDetails(Exception ex)
        {
            ...
            else
            {
                return new ProblemDetails
                {
                    ...
                    Detail = @"We apologize for inconvenience. Please let us know about the error at support@azuretest.com. Include traceId: {traceId} in email",
                    Instance = traceId
                };
            }
        }
